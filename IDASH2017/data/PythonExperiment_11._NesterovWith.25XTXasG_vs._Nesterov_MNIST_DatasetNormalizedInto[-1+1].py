...
for colidx in range(len(X[0])):
	...
	for (rowidx, row) in enumerate(X):
		if colmax < abs(row[colidx]) :
			colmax = abs(row[colidx])
	if colmax > epsilon :
		for (rowidx, row) in enumerate(X):
			row[colidx] = row[colidx] / colmax 
...
# -------------- FILE: MLE -------------- 
# -- Iterations -- NAG -- NAGG -- 
#filePath = 'PythonExperiment_NAGvs.NAGG_data103x1579gamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_edingamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_lbwgamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_nhanes3gamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_pcsgamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_uisgamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_Creditgamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
filePath = 'PythonExperiment_NAGvs.NAGG_MNISTgamma.9**iter_DatasetNormalizedInto[-1+1]_MLE.csv';
