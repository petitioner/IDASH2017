...
filePath = 'PythonExperiment_Adagradvs.AdagradG_data103x1579_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_edin_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_lbw_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_nhanes3_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_pcs_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_uis_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_Credit_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adagradvs.AdagradG_MNIST_DatasetNormalizedInto[-1+1]_MLE.csv';
