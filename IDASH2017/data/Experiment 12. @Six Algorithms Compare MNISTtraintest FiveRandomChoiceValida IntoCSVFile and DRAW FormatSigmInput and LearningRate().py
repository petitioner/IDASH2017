...
print '-------------    Data Set : MNIST train test                         -------------'
...
str_dataset = 'Experiment Result ' + 'MNISTtraintest '
...
plt.plot(range(len(Emethod_TEST_NesterovWithXTXasG_MLE)), Emethod_TEST_NesterovWithXTXasG_MLE, '^--r')
#plt.axis("equal")
#plt.title('Five_Cross_Validation_TEST_MLE')
...
plt.xlabel("Iteration Number")
plt.ylabel("Maximum Log-likelihood Estimation")
#plt.xlim([1, len(Emethod_TRAIN_Bonte_MLE)-2])
plt.legend(label, loc = 4, ncol = 1)  
plt.grid()
plt.show()
#plt.savefig("MLE4.png")
...
filePath = 'ICANN2020_PythonExperiment_MNIST1579_FiveCV_SFHvs.SFHGvs.NAGvs.NAGG_TRAIN_MLE.csv';
...
# ---------------- FILE: TEST MLE --------------- 
# -- Iterations -- SFH -- SFHG -- NAG -- NAGG -- 
filePath = 'ICANN2020_PythonExperiment_MNIST1579_FiveCV_SFHvs.SFHGvs.NAGvs.NAGG_TEST_MLE.csv';
PythonExperimentMNIST =      open(filePath,      'w')
PythonExperimentMNIST =      open(filePath,      'a+b')
...
# --------------- FILE: TRAIN AUC -------------- 
# -- Iterations -- SFH -- SFHG -- NAG -- NAGG -- 
filePath = 'ICANN2020_PythonExperiment_MNIST1579_FiveCV_SFHvs.SFHGvs.NAGvs.NAGG_TRAIN_AUC.csv';
PythonExperimentMNIST =      open(filePath,      'w')
PythonExperimentMNIST =      open(filePath,      'a+b')
...
# ---------------- FILE: TEST MLE --------------- 
# -- Iterations -- SFH -- SFHG -- NAG -- NAGG -- 
filePath = 'ICANN2020_PythonExperiment_MNIST1579_FiveCV_SFHvs.SFHGvs.NAGvs.NAGG_TEST_AUC.csv';
PythonExperimentMNIST =      open(filePath,      'w')
PythonExperimentMNIST =      open(filePath,      'a+b')
