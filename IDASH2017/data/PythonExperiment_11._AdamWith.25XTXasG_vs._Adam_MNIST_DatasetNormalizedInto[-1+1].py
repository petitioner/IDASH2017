...
filePath = 'PythonExperiment_Adamvs.AdamG_data103x1579_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_edin_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_lbw_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_nhanes3_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_pcs_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_uis_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_Credit_DatasetNormalizedInto[-1+1]_MLE.csv';
#filePath = 'PythonExperiment_Adamvs.AdamG_MNIST_DatasetNormalizedInto[-1+1]_MLE.csv';
