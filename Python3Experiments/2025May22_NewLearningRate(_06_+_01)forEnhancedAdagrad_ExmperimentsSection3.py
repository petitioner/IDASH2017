# -*- coding: utf-8 -*-
"""2025May22 NewLearningRate(.06 +.01)forEnhancedAdagrad ExmperimentsSection3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PHbQbl89f9CP-Zls01xwj47imp1hGfTs
"""
...
for iter in range(MAX_ITER):
	...
	for idx in range(mxtmx.shape[0]):
		Gamma[idx,idx] = (.06 +.01) / math.sqrt(epsilon + Gt[idx,idx])
