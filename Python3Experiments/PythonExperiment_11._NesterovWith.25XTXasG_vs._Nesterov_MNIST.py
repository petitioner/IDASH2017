...
# -------------- FILE: MLE -------------- 
# -- Iterations -- NAG -- NAGG -- 
#filePath = 'PythonExperiment_NAGvs.NAGG_data103x1579gamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_edingamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_lbwgamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_nhanes3gamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_pcsgamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_uisgamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_Creditgamma.9**iter_MLE.csv';
#filePath = 'PythonExperiment_NAGvs.NAGG_MNISTgamma.9**iter_MLE.csv';
...
#filePath = 'PythonExperiment_NAGvs.NAGG_Credit_MLE.csv';
filePath = 'PythonExperiment_NAGvs.NAGG_MNIST_MLE.csv';
PythonExperimentMNIST =      open(filePath,      'w')
PythonExperimentMNIST =      open(filePath,      'a+b')

PythonExperimentMNIST.write('Iterations'.encode('utf-8')); 
PythonExperimentMNIST.write(','.encode('utf-8'));
PythonExperimentMNIST.write('NAG'.encode('utf-8'));    
PythonExperimentMNIST.write(','.encode('utf-8')); 
PythonExperimentMNIST.write('NAGG'.encode('utf-8'));   
PythonExperimentMNIST.write("\n".encode('utf-8'));

for (idx, ele) in enumerate(EmethodNesterovWith_MLE):
	PythonExperimentMNIST.write(str(idx).encode('utf-8')); 
	PythonExperimentMNIST.write(','.encode('utf-8'));
	PythonExperimentMNIST.write(str(EmethodNesterov_MLE[idx]).encode('utf-8'));
	PythonExperimentMNIST.write(','.encode('utf-8'));
	PythonExperimentMNIST.write(str(EmethodNesterovWith_MLE[idx]).encode('utf-8'));
	PythonExperimentMNIST.write("\n".encode('utf-8'));
