# -*- coding: utf-8 -*-
"""2025May22 NewLearningRate(.01 + 0.001)forEnhancedAdam ExmperimentsSection3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1jsBmOPh0FAEFNCWbhq-rdePN1Cg5iAnO
"""
...
for iter in range(MAX_ITER):
	...
	for idx in range(mxtmx.shape[0]):
		Gamma[idx,idx] = (.01 +  alpha) / (math.sqrt(MvtHat[idx,0]) + epsilon)
	...
	for idx in range(len(Y)):
		...
		newhypothesis.append(hx)
	hxlist = [ hx for hx in newhypothesis ]
	print(iter, '-th AUC : ', ROCAUC(hxlist, Y), ' MLE = ', loglikelihood);print(alpha )
